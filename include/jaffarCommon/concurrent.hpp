...
public:
   ...
   */
  __JAFFARCOMMON__INLINE__ auto& getInternalStorage() { return _internalDeque; }
   ...
   */
  __JAFFARCOMMON__INLINE__ void push_back_no_lock(T element) { _internalDeque.push_back(element); }
   ...
   * @param[in] element The input element to push
   */
  __JAFFARCOMMON__INLINE__ void push_back(T element)
  {
    _mutex.lock();
   ...
   * @param[in] element The input element to push
   */
  __JAFFARCOMMON__INLINE__ void push_front_no_lock(T element) { _internalDeque.push_front(element); }
   ...
   * @param[in] element The input element to push
   */
  __JAFFARCOMMON__INLINE__ void push_front(T element)
  {
    _mutex.lock();
   ...
   */
  __JAFFARCOMMON__INLINE__ T front() const { return _internalDeque.front(); }
   ...
   */
  __JAFFARCOMMON__INLINE__ T back() const { return _internalDeque.back(); }
   ...
   * @note This operation does not check for an empty container and might produce unexpected behaviour if ran with an empty container
   */
  __JAFFARCOMMON__INLINE__ void pop_front()
  {
    _mutex.lock();
   ...
   * @note This operation does not check for an empty container and might produce unexpected behaviour if ran with an empty container
   */
  __JAFFARCOMMON__INLINE__ void pop_back()
  {
    _mutex.lock();
   ...
   */
  __JAFFARCOMMON__INLINE__ bool pop_back_get(T& element)
  {
    _mutex.lock();
   ...
   * @return True, if the operation was successful; false, if the Deque was empty
   */
  __JAFFARCOMMON__INLINE__ bool pop_front_get(T& element)
  {
    _mutex.lock();
   ...
   */
  __JAFFARCOMMON__INLINE__ size_t wasSize() const { return _internalDeque.size(); }
