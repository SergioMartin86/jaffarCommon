 ...
 */
__JAFFAR_COMMON_INLINE__ int kbhit()
{
  int ch, r;
 ...
 */
__JAFFAR_COMMON_INLINE__ int waitForKeyPress()
{
 ...
 */
__JAFFAR_COMMON_INLINE__ int getKeyPress()
{
 ...
 */
__JAFFAR_COMMON_INLINE__ void refreshTerminal()
{
