...
public:
   ...
   */
  __JAFFAR_COMMON_INLINE__ size_t getInputSize() const { return _inputDataBufferPos; }
   ...
   */
  __JAFFAR_COMMON_INLINE__ const uint8_t* getInputDataBuffer() const { return _inputDataBuffer; }
