 ...
 */
__JAFFARCOMMON__INLINE__ timePoint now() { return std::chrono::high_resolution_clock::now(); };
 ...
 */
__JAFFARCOMMON__INLINE__ double timeDeltaSeconds(const std::chrono::time_point<std::chrono::high_resolution_clock> end,
 ...
 */
__JAFFARCOMMON__INLINE__ size_t timeDeltaNanoseconds(const std::chrono::time_point<std::chrono::high_resolution_clock> end,
                                                     const std::chrono::time_point<std::chrono::high_resolution_clock> start)
{
 ...
 */
__JAFFARCOMMON__INLINE__ size_t timeDeltaMicroseconds(const std::chrono::time_point<std::chrono::high_resolution_clock> end,
                                                      const std::chrono::time_point<std::chrono::high_resolution_clock> start)
{
