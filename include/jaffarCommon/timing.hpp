 ...
 */
__JAFFAR_COMMON__INLINE__ timePoint now() { return std::chrono::high_resolution_clock::now(); };
 ...
 */
__JAFFAR_COMMON__INLINE__ double timeDeltaSeconds(const std::chrono::time_point<std::chrono::high_resolution_clock> end,
 ...
 */
__JAFFAR_COMMON__INLINE__ size_t timeDeltaNanoseconds(const std::chrono::time_point<std::chrono::high_resolution_clock> end,
                                                      const std::chrono::time_point<std::chrono::high_resolution_clock> start)
{
 ...
 */
__JAFFAR_COMMON__INLINE__ size_t timeDeltaMicroseconds(const std::chrono::time_point<std::chrono::high_resolution_clock> end,
                                                       const std::chrono::time_point<std::chrono::high_resolution_clock> start)
{
