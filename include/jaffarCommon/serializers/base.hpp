...
public:
   ...
   */
  __JAFFAR_COMMON__INLINE__ size_t getOutputSize() const { return _outputDataBufferPos; }
   ...
   */
  __JAFFAR_COMMON__INLINE__ uint8_t* getOutputDataBuffer() const { return _outputDataBuffer; }
